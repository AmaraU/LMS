...
export const CohortPage = () => {
    ...
    const filteredCohorts = cohorts.filter(coho => {
        const searchLower = search.toLowerCase();
        return (
            coho.cohort_name.toLowerCase().includes(searchLower) ||
            coho.cohort_number.toLowerCase().includes(searchLower) ||
            coho.description.toLowerCase().includes(searchLower)
        );
    });
                    ...
                    {isLoading ? <h5 className={styles.loading}>Loading...</h5> :
                        ...
                        filteredCohorts.length === 0 ?
                            ...
                            <div className={styles.cohorts}>
                                ...
                                {filteredCohorts.map((coho, index) => (
