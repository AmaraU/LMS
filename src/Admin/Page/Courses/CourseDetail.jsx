            ...
            <Modal isOpen={isOpenExam}>
                <div className={styles.addContent}>
                    ...
                    <form className={styles.contentBody}>
                        ...
                        <input type="number" name="total_score" placeholder="Enter total possible marks" onChange={newExamInput} />
            ...
            <Modal isOpen={isEditExam}>
                <div className={styles.addContent}>
                    ...
                    <form className={styles.contentBody}>
                        ...
                        <label>Total Marks</label>
                        <input type="text" name="total_score" placeholder="Enter total possible marks" value={selected?.total_score} onChange={editExamInput} />
